...
local SetProps, SetChildren, InsertTheme, Create do
	...
	pcall(Save, "Make by TienDay.json")
end
...
function redzlib:SetTheme(NewTheme)
	...
	SaveJson("Make by TienDay.json", redzlib.Save)
...
function redzlib:MakeWindow(Configs)
	local WTitle = Configs[1] or Configs.Name or Configs.Title or "Make by TienDay"
	local WMiniText = Configs[2] or Configs.SubTitle or "by : Make by TienDay"
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Đóng Ứng Dụng",
			Text = "Bạn Muốn Tắt Script Này Không :((",
			Options = {
				{"Có", function()
					ScreenGui:Destroy()
				end},
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			MinimizeButton.Image = "rbxassetid://10747384217"
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddDiscordInvite(Configs)
			...
			local JoinButton = Create("TextButton", FrameHolder, {
				...
				Text = "Sao Chép Link Để Tìm Kiếm Hỗ Trợ",
				Font = Enum.Font.GothamBold,
				TextSize = 12,
			...
			JoinButton.Activated:Connect(function()
				...
				ClickDelay = true
				SetProps(JoinButton, {
					Text = "Đã Sao Chép Link Thành Công",
					BackgroundColor3 = Color3.fromRGB(100, 100, 100),
					TextColor3 = Color3.fromRGB(150, 150, 150)
				})task.wait(5)
				SetProps(JoinButton, {
					Text = "Sao Chép Link Để Xem Và Tải Script Mới",
					BackgroundColor3 = Color3.fromRGB(50, 150, 50),
					TextColor3 = Color3.fromRGB(220, 220, 220)
				})ClickDelay = false
			end)
